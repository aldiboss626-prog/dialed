...
function makeStyles(c: ColorPalette) {
  return StyleSheet.create({
    ...
    tipTitle: { fontFamily: FontFamily.display, fontSize: 17, color: c.primary, marginBottom: 6, flex: 1 },
    tipBody: { fontFamily: FontFamily.sans, fontSize: 14, color: c.secondary, lineHeight: 21 },
    divider: { height: 1, backgroundColor: c.border, marginVertical: 12 },
    templateLabel: { fontFamily: FontFamily.sansMedium, fontSize: 13, color: c.secondary, marginBottom: 6 },
    ...
    bullet: { width: 6, height: 6, borderRadius: 3, backgroundColor: c.gold, marginTop: 7, flexShrink: 0 },
    ...
    skeletonBox: { gap: 10, paddingVertical: 4 },
  })
}
...
export default function Networking101Page() {
  ...
  const refreshProgress = useCallback(async () => {
    await getCompletionPercent(TOPIC, TOTAL_ITEMS)
  ...
  return (
    <View style={styles.screen}>
      <TopicPageHeader title="Networking 101" completedCount={completedCount} totalItems={TOTAL_ITEMS} />
